...
# Step 1 – Training data
 train = [
    ...
    ("Nifty India,ONGC and gail marginally higher","Positive"),
    ("Nifty ends marginally up on BSE","Positive"),
    ("Modest Monday Nifty ends above 7500 mark in choppy session","Positive"),
    ("Nifty zooms 10%","Positive"),
    ("Nifty declares interim dividend; stock zooms 7%","Positive"),
    ...
    (" Nifty Dividend delight! Bharat Forge, Welspun India others declare dividend","Positive"),
    ("Nifty, Welspun India among 15 scrips that hit 52-week high","Positive"),
